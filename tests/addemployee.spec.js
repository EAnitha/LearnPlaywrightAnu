...
test('verify admin can create employee with mandatory fields', async ({ page }) => {
...
// excel data usage
  ...
  await page.goto('https://opensource-demo.orangehrmlive.com/web/index.php/pim/viewPersonalDetails/empNumber/235');
